...
router.route("/terminated/get-agreement/:id").get(getAll_terminated_agreements);
...
router.route("/search/terminated/:id").get(agreement_search_opr_terminated);
...
router
  .route("/get-search-operations-monthlyrent/paid")
  .get(get_monthly_search_opr_paid);
