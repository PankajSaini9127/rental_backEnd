...
const siteLinK = 'http://localhost:3000/newPassword/'
    ...
    try {
        ...
        const message = {
            ...
            html: `<h1>Thanks for choosing us !!!</h1>
              <p>Hello ${check[0].name}, please <a href = ${siteLinK+check[0].email} >Click Here</a> to login Woodshala.</p>
...
router.post('/reset',async(req,res)=>{
    try {
        ...
        {
            let response = await db.table('users').where('email',req.body.email).update('password',req.body.password)
